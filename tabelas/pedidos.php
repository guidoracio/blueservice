...
$s_total        = "SELECT COUNT(*) AS Pedidos FROM pedidos WHERE apagado='N' AND id_cliente='$ID_CLIENTE'";
...
$s_total_busca        = "SELECT COUNT(*) AS PedidosBusca FROM pedidos WHERE apagado='N' AND id_cliente='$ID_CLIENTE'".$searchQuery;
...
///// LISTAR
$s_listar = "SELECT * FROM pedidos WHERE apagado='N' AND id_cliente='$ID_CLIENTE'".$searchQuery." ORDER BY ".$columnName." ".$columnSortOrder." LIMIT ".$row.",".$rowperpage;
