...
<div class="row mb-3">
  <div class="col-md-4">
    ...
    <select name="status_pedido" class="form-select" id="status_pedido" disabled>
...
<table id="PedidosItensListar" class="table table-striped py-4 border-top border-bottom">
  <thead>
    <tr>
      <th scope="col" width="80" class="text-center no-sort">ID</th>
      <th scope="col" class="no-sort">Produto</th>
      <th scope="col" width="200" class="text-center no-sort">Quantidade</th>
      <th scope="col" width="200" class="text-center no-sort">Valor</th>
    </tr>
  </thead>
  <tbody>
  </tbody>
