...
////////// LOGIN
if($_POST['acao']=='login') {
$login = anti_sql_injection(soNumeros($_POST['login']));
$senha = anti_sql_injection(md5($_POST['senha']));
  
//// DADOS
$s_dados = "SELECT * FROM clientes WHERE documento='$login' AND senha='$senha' AND status='S'";   
...
$_SESSION['CLIENTE_ID']    = $dados['id_cliente'];
$_SESSION['CLIENTE_LOGIN'] = $dados['documento'];
$_SESSION['CLIENTE_PASS']  = $dados['senha'];
