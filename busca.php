<?php 
$txt_busca = anti_sql_injection($_GET['txt_busca']);

////////// PRODUTOS
$s_produtos = "SELECT * FROM produtos WHERE status='S' AND (nome LIKE '%".$txt_busca."%' OR descricao LIKE '%".$txt_busca."%') ORDER BY rand() ASC";
